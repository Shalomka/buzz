...
/// The unchanged mobile shell: [IndexedStack] over the three home tabs
/// behind the floating tab bar. Extracted move-only from [HomePage]; this
/// is the permanent home of the mobile shell.
class _MobileHomeBody extends HookConsumerWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      minimum: const EdgeInsets.fromLTRB(
        _MobileHomeBody._tabBarHorizontalMargin,
        0,
        _MobileHomeBody._tabBarHorizontalMargin,
        _MobileHomeBody._tabBarBottomGap,
      ),
      child: Align(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(
                          _MobileHomeBody._tabBarInnerInset,
                        ),
                        child: SizedBox(
                          height:
                              _MobileHomeBody._tabBarHeight -
                              (_MobileHomeBody._tabBarInnerInset * 2),
                          child: Stack(
                            children: [
                              AnimatedAlign(
                                  ...
                                  child: Padding(
                                    ...
                                    child: DecoratedBox(
                                      decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(
                                          _MobileHomeBody._selectedTabRadius,
                                        ),
                                      ),
                                    ),
                                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        borderRadius: BorderRadius.circular(_MobileHomeBody._selectedTabRadius),
            ...
            child: Column(
              ...
              children: [
                AnimatedSwitcher(
                  duration: reducedMotion
                      ? Duration.zero
                      : _MobileHomeBody._tabIconWeightDuration,
